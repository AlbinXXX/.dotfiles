...
import { usePaneLayout, ChildLink, BackLink, ReferenceChildLink, ParameterizedLink, PaneRouterContext, useDeskTool, LOADING_PANE, SerializeError, Pane, PaneHeader, PaneContent, LoadingPane, PaneLayout, setActivePanes, DeskToolProvider } from './desk-cJxJ0kbl.js';
...
import { isRecord, useDocumentStore, useEditState, useSchema, unstable_useValuePreview, _isCustomDocumentTypeDefinition, useWorkspace, SourceProvider } from 'sanity';
...
const paneMap = {
  component: lazy(() => import('./index-sxW9EJQU.js')),
  document: lazy(() => import('./pane-eToixGNv.js')),
  documentList: lazy(() => import('./pane-hR_-_ClT.js')),
  list: lazy(() => import('./index-mDrOwUnY.js'))
};
...
//# sourceMappingURL=index-8F-z14WZ.js.map
